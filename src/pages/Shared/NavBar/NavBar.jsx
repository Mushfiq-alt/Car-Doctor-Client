...
const NavBar = () => {
    ...
    const navItems = <>
        ...
        <li><Link to="/service" className="font-bold">Service</Link></li>
    ...
    return (
        <div className="navbar bg-base-100 h-28 mb-4">
            ...
            <div className="navbar-end">
                <button className="border border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white py-2 px-4 font-bold">
                    Appointment 
                </button>
