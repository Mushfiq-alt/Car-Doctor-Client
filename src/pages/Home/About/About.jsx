        ...
        <div className="hero min-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row">
                <div className='lg:w-1/2 relative'>
                    ...
                    <img src={parts} className="w-1/2 absolute right-5 top-1/2 rounded-lg border-8 shadow-2xl" />
                </div>
                <div className='lg:w-1/2 space-y-5 p-4'>
                    ...
                    <button className="btn btn-primary" style={{ backgroundColor: '#FF3811', color: 'white', border: 'none' }}>Get More Info</button>
                </div>
            </div>
        </div>
    );
